...
date: "2024-12-09"
authors: "Michael Artin, Modified by: Josephine Soddano"
---
...
res_mod_noninv_17iggubt <- run_model(
  strat_serology = strat_serology,
  strat_ubt = strat_ubt,
  parameters = param,
  cycles = 35,
...
res_mod_noninv_17iggsat <- run_model(
  strat_stool = strat_stool,
  strat_serology = strat_serology,
  parameters = param,
  cycles = 35,
...
res_dsa_ubt_17iggsat <- run_dsa(
  model = res_mod_noninv_17iggsat,
  dsa = dsa_ubt
)
```
```{r Run DSA Model 17% HP NonInvasive, UBT vs Sero}
res_dsa_ubt_17iggubt <- run_dsa(
  model = res_mod_noninv_17iggubt,
  dsa = dsa_ubt
)
```
...
plot_res_dsa_ubt_17iggsat <- plot(res_dsa_ubt_17iggsat,
                                  strategy = "strat_serology",
                                  result = "icer",
                                  type = "difference"
)
plot_res_dsa_ubt_17iggsat
```
```{r Plot Model 17% HP Strategy, ICER, UBT vs Sero}
plot_res_dsa_ubt_17iggubt <- plot(res_dsa_ubt_17iggubt,
                                  strategy = "strat_ubt",
                                  result = "icer",
                                  type = "difference"
)
plot_res_dsa_ubt_17iggubt
```
...
# Get the top 10 variables from the tornado diagram.
dsa_top_teniggsat <- as.character(data.table(
  icer_diff = abs(
    plot_res_dsa_ubt_17iggsat$data$.icer[
      seq(nrow(plot_res_dsa_ubt_17iggsat$data))[c(TRUE, FALSE)]
    ] - plot_res_dsa_ubt_17iggsat$data$.icer[
      seq(nrow(plot_res_dsa_ubt_17iggsat$data))[c(FALSE, TRUE)]
    ]
  ),
  variable = plot_res_dsa_ubt_17iggsat$data$.par_names[c(TRUE, FALSE)]
)[order(-icer_diff)][1:10, variable])
...
# Get the top 10 variables from the tornado diagram.
dsa_top_teniggubt <- as.character(data.table(
  icer_diff = abs(
    plot_res_dsa_ubt_17iggubt$data$.icer[
      seq(nrow(plot_res_dsa_ubt_17iggubt$data))[c(TRUE, FALSE)]
    ] - plot_res_dsa_ubt_17iggubt$data$.icer[
      seq(nrow(plot_res_dsa_ubt_17iggubt$data))[c(FALSE, TRUE)]
    ]
  ),
  variable = plot_res_dsa_ubt_17iggubt$data$.par_names[c(TRUE, FALSE)]
)[order(-icer_diff)][1:10, variable])
...
# Trim our plot to the top ten most impactful variables.
plot_res_dsa_ubt_17iggsat$data <- plot_res_dsa_ubt_17iggsat$data[
  plot_res_dsa_ubt_17iggsat$data$.par_names %in% dsa_top_teniggsat,
]
plot_res_dsa_ubt_17iggsat
```
```{r Trim Top 10 Plot UBT vs Sero}
# Trim our plot to the top ten most impactful variables.
plot_res_dsa_ubt_17iggubt$data <- plot_res_dsa_ubt_17iggubt$data[
  plot_res_dsa_ubt_17iggubt$data$.par_names %in% dsa_top_teniggubt,
]
plot_res_dsa_ubt_17iggubt
```
...
# Time to prettify the plot.
plot_res_dsa_ubt_17iggsat$data$.par_names <- plot_res_dsa_ubt_17iggsat$data$.par_names |>
  dplyr::recode(
    c_first_line = "Cost of first-line eradication therapy",
    c_hospital = "Cost of hospitalization, PUD",
    c_second_line = "Cost of second-line eradication therapy",
...
plot_res_dsa_ubt_17iggsat$data$.strategy_names <- ""

plot_res_dsa_ubt_17iggsat$labels$y <- "Parameter"

list(plot_res_dsa_ubt_17iggsat$labels)
...
plot_res_dsa_ubt_17iggsat$data$.hjust[
  plot_res_dsa_ubt_17iggsat$data$.hjust == 0
] <- -0.1

plot_res_dsa_ubt_17iggsat$data$.hjust[
  plot_res_dsa_ubt_17iggsat$data$.hjust == 1
] <- 1.1
```
```{r Prettify Top 10 Plot UBT vs Sero}
# Time to prettify the plot.
plot_res_dsa_ubt_17iggubt$data$.par_names <- plot_res_dsa_ubt_17iggubt$data$.par_names |>
  dplyr::recode(
    c_first_line = "Cost of first-line eradication therapy",
    c_hospital = "Cost of hospitalization, PUD",
    c_second_line = "Cost of second-line eradication therapy",
...
plot_res_dsa_ubt_17iggubt$data$.strategy_names <- ""

plot_res_dsa_ubt_17iggubt$labels$y <- "Parameter"

list(plot_res_dsa_ubt_17iggubt$labels)
...
plot_res_dsa_ubt_17iggubt$data$.hjust[
  plot_res_dsa_ubt_17iggsat$data$.hjust == 0
] <- -0.1

plot_res_dsa_ubt_17iggubt$data$.hjust[
  plot_res_dsa_ubt_17iggubt$data$.hjust == 1
] <- 1.1
```
